...
_C.LOG_DIR =  '/project/zhanjiao/YOLOP/yolopx/runs'
_C.GPUS = (0,)     # 显卡数 = len(GPUS)
_C.WORKERS = 10      # 指数据装载时cpu所使用的线程数，默认为8（注意，一般默使用8的话，会报错~~。原因是爆系统内存）
_C.PIN_MEMORY = True
_C.PRINT_FREQ = 2150
...
_C.DATASET.DATAROOT = '/project/zhanjiao/dataset/bdd/bdd100k/images/100k'       # the path of images folder
_C.DATASET.LABELROOT = '/project/zhanjiao/dataset/bdd/bdd_det_gt'      # the path of det_annotations folder
_C.DATASET.MASKROOT = '/project/zhanjiao/dataset/bdd/bdd_seg_gt'                # the path of da_seg_annotations folder
_C.DATASET.LANEROOT = '/project/zhanjiao/dataset/bdd/bdd_lane_gt'               # the path of ll_seg_annotations folder
