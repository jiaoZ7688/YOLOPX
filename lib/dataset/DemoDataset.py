...
from ..utils import letterbox_for_img, clean_str, letterbox
...
class LoadImages:  # for inference
    ...
    def __next__(self):
        ...
        input_img, ratio, pad = letterbox_for_img(img0, resized_shape, auto=True)
        ...
        return path, input_img, img0, self.cap, shapes
